"""Shared data-path resolution (same contract as labctl.paths)."""
from __future__ import annotations

try:
    from labctl.paths import data_path, find_repo_root
except ImportError:  # pragma: no cover - standalone install without labctl
    import os
...
__all__ = ["data_path", "find_repo_root"]
